    ...
    return (
        <Drawer.Root>
            ...
            <Drawer.Portal>
                ...
                <Drawer.Content className="bg-gray-100 flex flex-col rounded-t-[10px] mt-24 h-96 fixed bottom-0 left-0 right-0 outline-none">
                    {/* header */}
                    <div className="sticky top-0 z-10 bg-white rounded-t-[10px] px-4 pt-4 space-y-4">
                        <div aria-hidden className="mx-auto w-8 h-1 shrink-0 rounded-full bg-gray-300 mb-4" />
                        <div className="flex items-center">
                            <Icon icon={backIcon} className="text-gray-900 text-xl text-right cursor-pointer" onClick={() => {
                                setShowMenu(true)
                                setShowSubMenu(false)
                            }} />
                            <Drawer.Title className="font-medium text-gray-900 text-lg text-center mx-auto translate-x-3">دسته‌بندی‌ها</Drawer.Title>
                        </div>
