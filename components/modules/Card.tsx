...
const Card: React.FC<courseType> = ({ src, title, lesson, members, level, teacher, rate, price, discount}) => {
    return (
            ...
            <section className="flex flex-col gap-7">
                ...
                <div className="flex gap-5 text-gray-500 text-sm font-medium h-2">
                    ...
                    <div className="flex items-center gap-1.5 dark:text-gray-50">
                        <Icon className="text-pink-500 text-xl" icon={chartIcon} />
                        <p className="w-5 truncate">{level}</p>
                    </div>
                </div>
            </section>
