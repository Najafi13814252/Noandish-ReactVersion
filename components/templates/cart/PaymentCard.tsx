...
function PaymentCard() {
    ...
    return (
        <div className="">
            <section className="border border-gray-200 rounded-lg p-4 flex flex-col gap-4 divide-y divide-gray-200">
                ...
                <div className="flex items-center justify-between pb-4">
                    <p>تخفیف</p>
                    <p className="px-2 py-1 rounded-md bg-main-100/10 text-main-100 text-sm">{profit.toLocaleString('fa-ir')} تومان</p>
                </div>
