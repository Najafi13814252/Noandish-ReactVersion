...
function Hero() {
    return (
        <section className="flex md:flex-row flex-col-reverse items-center justify-between px-2 md:px-6 rounded-lg font-dana">
            <div className="text-center md:text-right">
                ...
                <p className="md:text-lg text-base font-medium max-w-lg text-gray-500 leading-relaxed my-8 dark:text-gray-200">بهترین و بروزترین
                ...
                <div className="flex gap-4 items-center justify-center md:justify-normal">
                    ...
                    <Link href="/learns">
                        <button
                            className="w-full md:w-fit flex items-center justify-center gap-2 text-white bg-first px-6 py-2 rounded-full bg-main-100 hover:bg-teal-600 duration-200 cursor-pointer">
